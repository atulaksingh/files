            ...
            <Col md={12} lg={6}>
              <div className="about-six__content mx-2 my-4">
                ...
                <div className="about-six__text">
                  As a global leader in IT infrastructure solutions, Zaco
                  understands how critical seamless support is to your
                  operations. Our highly-trained team delivers prompt responses
                  and best-in-class service to ensure optimal performance of
                  your environments. With over 20 years of experience supporting
                  all major technology brands, we have the expertise to resolve
                  even the most complex issues quickly. You can rely on our
                  technical specialists to keep your systems running smoothly
                  around the clock. We stay abreast of the latest innovations to
                  continuously enhance our capabilities and give you peace of
                  mind knowing your infrastructure is in capable hands.
                </div>
              </div>
            </Col>
          </Row>
